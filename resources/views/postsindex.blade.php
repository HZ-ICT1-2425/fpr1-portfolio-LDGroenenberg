    ...
    <section>
        <article>
            ...
            <p>
                ...
                In the mean time I started to pick up coding and got more ICT tasks at my work. <a href="{{ route('posts.show', 'studychoise') }}">...read more</a>
            </p>
        </article>
        <article>
            <h2>&lt;SWOT analysis/&gt;</h2>
            <p>
                ...
                <a href="{{ route('posts.show', 'swot-analysis') }}">...read more</a>
            </p>
        </article>
    </section>
    <section>
        <article>
            ...
            <p>
                ...
                <a href="{{ route('posts.show', 'experience') }}">...read more</a>
            </p>
        </article>
        <article>
            ...
            <p>
                ...
                Have you found the preparatory assignment? <a href="{{ route('posts.show', 'firstfeedback') }}">...read more</a>
            </p>
        </article>
    </section>
    <section>
        <article class="ictarticle">
            ...
            <p>
                ...
                But this year, in 2024, Qualcomm launched its Snapdragon X series, which also runs on ARM, but for Windows laptops. <a href="{{ route('posts.show', 'ictarticle') }}">...read more</a>
            </p>
        </article>
        <article class="sitefeedback">
            ...
            <p>
                ...
                so I adjusted the color scheme to create a more cohesive look. <a href="{{ route('posts.show', 'sitefeedback') }}">...read more</a>
            </p>
        </article>
    </section>
@endsection
